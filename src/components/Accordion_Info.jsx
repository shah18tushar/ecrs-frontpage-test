...
export default function Accordion_Info() {
  ...
  return (
    <section className="py-10 relative">
      {/* Background Design */}
      <div className="absolute inset-0 -z-10">
        <div className="h-full w-full bg-gradient-to-t from-red-400 to-transparent opacity-10" />
      </div>
              ...
              <AccordionItem value="question4">
                ...
                <AccordionContent className="p-4 bg-white rounded-b-lg shadow-lg text-gray-700">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>
                      <strong>Pre-Purchase:</strong> Pay for a full tank upfront
                      at a discounted rate and return at any level
                    </li>
                    <li>
                  ...
                  <p className="mt-3">
                    Fuel service charges apply if the tank isn't returned at the
                    agreed level.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="question5">
                ...
                <AccordionContent className="p-4 bg-white rounded-b-lg shadow-lg text-gray-700">
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <li>Take photos of the scene and all vehicles involved</li>
                    <li>
              ...
              <AccordionItem value="question6">
                ...
                <AccordionContent className="p-4 bg-white rounded-b-lg shadow-lg text-gray-700">
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    ...
                    <li>
                      Cross-border one-way rentals have additional requirements
                    </li>
                  </ul>
                  <p className="mt-3">
