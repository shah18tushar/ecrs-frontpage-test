...
export default function ContactPage() {
  ...
  return (
    <div className="text-black relative z-10">
      ...
      <section className="relative w-full h-[350px] md:h-[270px] mt-10 overflow-hidden flex items-center justify-center bg-white">
        ...
        <div className="relative z-10 text-center px-4">
          <SplitText
            text="Contact Us"
            className="text-5xl md:text-5xl font-bold text-gray-900"
            delay={80}
            duration={0.6}
            ease="power3.out"
            splitType="chars"
