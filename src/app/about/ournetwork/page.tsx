...
const OurNetworkPage = () => {
    ...
    const networkData = {
        "Gujarat": {
            cities: ["Rajkot", "Gandhidham", "Jamnagar", "Bhuj", "Vadodara", "Bhavnagar", "Surat", "Ahmedabad", "Silvassa", "Vapi", "Sonmath" ,  "Gandhidham", "Jamnagar", "Bhuj", "Vadodara", "Bhavnagar", "Surat", "Ahmedabad", "Silvassa", "Vapi", "Sonmath"],
            image: "/Gujrat.jpg"
        },
        "Maharashtra": {
            cities: ["Rajkot", "Gandhidham", "Jamnagar", "Bhuj", "Vadodara", "Bhavnagar", "Surat", "Ahmedabad", "Silvassa", "Vapi", "Sonmath" ,  "Gandhidham", "Jamnagar", "Bhuj", "Vadodara", "Bhavnagar", "Surat", "Ahmedabad", "Silvassa", "Vapi", "Sonmath"],
    ...
    return (
        <div className="text-black">
            ...
            {/* Network Statistics */}
           <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto px-4">
    {[
        { value: Object.keys(networkData).length, label: "States Covered" },
        { value: totalCities, label: "Cities Connected" },
        { value: "180+", label: "Growing Network" }
    ].map((stat, index) => (
        <div key={index} className="group relative">
           
            
            {/* Stat card */}
            <div className="relative h-full text-center p-6 bg-white rounded-xl shadow-2xl border border-gray-50 overflow-hidden transition-all duration-300">
                {/* Decorative accent */}
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-red-500 to-red-500"></div>
                ...
                <div className="relative">
                    ...
                    <div className="text-lg font-semibold text-gray-700 font-serif tracking-wider">
                        {stat.label}
                    </div>
                </div>
                
                {/* Premium corner element */}
                <div className="absolute bottom-2 right-2 text-red-400 opacity-30">
            ...
            <section>
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex flex-col md:flex-row gap-8">
                        {/* Left Section - States (w-1/4 and h-[450px]) */}
                        <div className="bg-white w-full md:w-1/4 rounded-2xl shadow-2xl p-4 border h-[550px] border-gray-100 flex flex-col">
                            <div className="mb-6">
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">States</h3>
                                <div className="relative">
                                    <Search className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                            ...
                            <div className="flex-grow overflow-y-auto overflow-x-hidden">
                                <div className="space-y-4">
                                    {filteredStates.map((state, index) => (
                                        <div
                                            key={state}
                                            className={`p-4 rounded-xl cursor-pointer transition-all duration-300 group transform ${
                                                selectedState === state
                        ...
                        {/* Right Section - Cities and Image (w-3/4 and h-[450px]) */}
                        <div className="bg-white  w-full md:w-3/4 rounded-2xl shadow-2xl p-6 border h-full border-gray-100">
                            {selectedState ? (
                                <div className="h-full flex flex-col">
                                    <div className="mb-4">
                                        <h3 className="text-xl font-semibold tracking-wide leading-normal font-serif text-gray-800">
                                           Cities In {selectedState}
                                        </h3>
                                        {/* <p className="text-gray-600">
                                            {getCitiesToDisplay().length} cities available
                                    ...
                                    <div className="flex-grow flex flex-col lg:flex-row gap-6 min-h-0">
                                        ...
                                        <div className="flex-1 overflow-y-hidden">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 h-min ">
                                                {getCitiesToDisplay().map((city, index) => (
                                                    <div
                                                        key={city}
                                                        className="p-2"
                                        ...
                                        {/* State Image - Takes right half */}
                                        <div className="hidden lg:block relative rounded-xl overflow-hidden shadow-lg w-full lg:w-1/2 flex-shrink-0  h-[350px]">
                               ...
                               <div className="h-[350px] flex items-center justify-center bg-white rounded-lg shadow-sm border border-gray-100">
    <div className="text-center p-6 max-w-md">
        <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-red-50 mb-5">
            <MapPin className="h-8 w-8 text-red-500" />
        </div>
        <h3 className="text-lg font-medium text-gray-900 mb-2">Select a state to view cities</h3>
        <p className="text-gray-500 mb-4">Choose from the list on the left to get started</p>
        <div className="mt-4">
