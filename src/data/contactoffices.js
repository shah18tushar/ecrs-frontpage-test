export const offices = [
  {
    ...
    lat: 18.646,
    lng: 73.77, // Akurdi Pune
  },
  {
    title: "Branch Office - PCMC (Operations)",
    address:
      "Opp. Kunal Residency, Pawar Nagar, Near Aditya Birla Hospital, Chinchwad -Thergaon, Pune – 411 033.",
    phones: ["020-67676060", "+91 7507775790"],
    emails: ["reservations@ecrspune.com"],
    lat: 18.61,
  ...
  },
  {
    ...
    emails: ["booking.mumbai@ecrs.co.in"],
    lat: 19.099,
  ...
  },
  {
    ...
    emails: ["booking@ecrspune.com"],
    lat: 18.521,
    lng: 73.855, // Pune Airport
  },
];
